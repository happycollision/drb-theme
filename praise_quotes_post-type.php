...
function praise_author_meta() {
  ...
  $praise_topic = $custom["praise_topic"][0];
  ?>
  ...
  <p><label>Praise Topic: (optional)</label><br />
  <input type="text" value="<?php echo $praise_topic; ?>" size="50" name="praise_topic">
  </p>
...
function save_praise_details(){
	...
	update_post_meta($post->ID, "praise_topic", $_POST["praise_topic"]);
	}
}
